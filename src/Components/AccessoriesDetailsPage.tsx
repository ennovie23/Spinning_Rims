...
const AccessoriesDetailsPage = ({ name, price, description, images, specs }: AccessoriesDetailsPageProps) => {
              ...
              <Table>
                <TableBody>
                  {specs.map((spec, index) => (
                    <TableRow key={index} sx={{ borderBottom: "1px solid black", borderTop: "1px solid black",borderLeft:"3xp solid black" }}>
